...
public abstract class AbstractCollectionTest extends junit.framework.TestCase
{
    ...
    {
        int size = 10;
        Collection<Integer> c1 = getCollection(sequenceGenerator);
        Collection<Integer> c2 = getCollection(
            new IntegerGenerator(SEQUENCE_SIZE * 2));
    ...
    public void testRetainAll()
    {
        ...
        Collection<Integer> c = getCollection(arr1);
        Collection<Integer> toBeRetained = getCollection(arr2);
        
        c.retainAll(toBeRetained);
        for (Iterator<Integer> itr = toBeRetained.iterator(); itr.hasNext(); )
        {
            assertTrue(c.contains(itr.next()));
        }
        assertEquals(6, c.size());
    }
