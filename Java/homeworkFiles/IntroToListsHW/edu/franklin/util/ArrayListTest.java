...
public class ArrayListTest extends AbstractListTest
{
    ...
    public void testSetMethod()
    {
        ...
        Integer obj = new Integer(17);
        //move to index zero
        assertEquals(new Integer(0), itr.next());
        //set into index zero
        itr.set(obj);
        //check obj was set into index zero
        ...
        //set into index two
        itr.set(obj);
        //check obj was set into index two
        assertEquals(obj, list.get(2));
        //move to index 1
        itr.previous();
        assertEquals(new Integer(1), itr.previous());
        //set into index one
        itr.set(obj);
        //check obj was set into index one
