...
<body>
    <div id="wrapper">
        ...
        <div id="contentContainer">
            ...
            <table id="gradesContent">
                <tr class="open">
                    <td class="centerAll gradesLeft">Subject</td>
                    <td class="centerAll gradesMid">Percentage</td>
                    <td class="centerAll">Grade</td>
                </tr>
                <?php echo getCourseGrades(); ?>
            </table>
        </div>
        <script type="text/javascript" src="javascript/showRows.js"></script>
    </div>
</body>
</html>
<?php
